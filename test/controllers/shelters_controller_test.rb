...
class SheltersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shelter" do
    assert_difference('Shelter.count') do
      post shelters_url, params: { shelter: { address: @shelter.address, describe: @shelter.describe, name: @shelter.name } }
    end
  ...
  test "should update shelter" do
    patch shelter_url(@shelter), params: { shelter: { address: @shelter.address, describe: @shelter.describe, name: @shelter.name } }
