...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { about: @register.about, address: @register.address, age: @register.age, email: @register.email, name: @register.name, occupation: @register.occupation, phone: @register.phone } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { about: @register.about, address: @register.address, age: @register.age, email: @register.email, name: @register.name, occupation: @register.occupation, phone: @register.phone } }
